...
<head>
    ...
    <style>
        ...
        .student-box { border: 1px solid #9ca3af; padding: 10px 12px; margin-bottom: 12px; }
        ...
        .grades-table th, .grades-table td { border: 1px solid #9ca3af; padding: 6px 5px; font-size: 10px; }
        .grades-table thead th { background: #eef2ff; text-align: center; }
        .grades-table td.subject-name { white-space: nowrap; }
        .grades-table td.number, .grades-table th.number { text-align: center; width: 40px; }
        .summary-grid { width: 100%; border-collapse: collapse; margin-bottom: 16px; }
        .summary-grid td { width: 25%; border: 1px solid #d1d5db; padding: 8px 10px; }
        .summary-grid .label { display: block; color: #6b7280; font-size: 10px; margin-bottom: 3px; }
        .summary-grid .value { font-size: 12px; font-weight: bold; }
        .signatures { width: 100%; border-collapse: collapse; margin-top: 18px; }
        .signatures td { width: 50%; text-align: center; vertical-align: top; }
        .sign-space { height: 78px; position: relative; }
        .sign-space img.signature { max-width: 160px; max-height: 64px; object-fit: contain; }
        .sign-space img.stamp { position: absolute; top: 8px; left: 50%; transform: translateX(-50%); max-width: 90px; max-height: 90px; opacity: 0.30; }
        .qr-block { width: 90px; text-align: center; margin: 0 auto; }
        .qr-block img { width: 68px; height: 68px; }
        .footer-note { margin-top: 10px; color: #6b7280; font-size: 9px; }
        .template-html p { margin: 0 0 10px; line-height: 1.55; }
    ...
    <table class="grades-table">
        <thead>
            <tr>
                ...
                <th class="number">S1</th>
                <th class="number">S2</th>
                <th class="number">S3</th>
                <th class="number">S4</th>
                <th class="number">S5</th>
                <th class="number">S6</th>
                <th class="number">Rata-rata</th>
            </tr>
        </thead>
        <tbody>
